...
cor_matrix <- cor(numeric_data, use = "complete.obs")  # 'complete.obs' gestisce i missing values

# Visualizza la matrice di correlazione
corrplot(cor_matrix, method = "color", order = "hclust", 
         addCoef.col = "black", # Aggiunge il coefficiente di correlazione
         tl.col = "black", tl.srt = 45) # Gestisce le etichette degli assi
